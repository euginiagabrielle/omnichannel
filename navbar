                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown" style='margin-left: 5px;'>
                        ...
                        <ul class="dropdown-menu" style='font-size: 16px;'>
                            <li><a class="dropdown-item" href="periodicReports.php">Periodic Sales Reports</a></li>
                            <li><a class="dropdown-item" href="bestSelling.php">Best selling product</a></li>
                            <li><a class="dropdown-item" href="mostSales.php">E-commerce with the most sales</a></li>
                        </ul>
                    </li>
                    <li class="nav-item" style='margin-left: 5px;'>
